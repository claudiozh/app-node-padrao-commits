...
[Como padronizar commits? #DevTips Conventional Commits + Semantic Release para releases e versioning
](https://www.youtube.com/watch?v=1eTofdmfq1g)
...
[Especificação do Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0/)
...
* [Link para o site da biblioteca](http://commitizen.github.io/cz-cli
...
Feito isso será instalado os pacotes necessários

Para testar faça alteração em alguma arquivo, por exemplo no index.js e rode:
